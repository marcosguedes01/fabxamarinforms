...
namespace FABExample
{
    public class FloatingActionButtonView : View
    {
        ...
        public static readonly BindableProperty SizeProperty = 
            BindableProperty.Create<FloatingActionButtonView, FloatingActionButtonSize>(p => p.Size, FloatingActionButtonSize.Normal);
        ...
        public FloatingActionButtonView() : base() {
